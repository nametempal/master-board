...
## 🚀 Live Demo
[https://nametempal.github.io/master-board/](https://nametempal.github.io/master-board/)
...
- **Manual Override**: Click the timer to switch between dashboards immediately.
- **Zero Configuration**: Built as a single, lightweight HTML file with vanilla CSS and JS.

## 📦 Dashboards Included
1. **Delivery Dashboard**: [https://nametempal.github.io/delivery-dashboard/](https://nametempal.github.io/delivery-dashboard/)
2. **TV Dashboard**: [https://nametempal.github.io/tv-dashboard/](https://nametempal.github.io/tv-dashboard/)
